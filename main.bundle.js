...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_ngx_auto_scroll__ = __webpack_require__("../../../../ngx-auto-scroll/ngx-auto-scroll.es5.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14_time_ago_pipe__ = __webpack_require__("../../../../time-ago-pipe/esm5/time-ago-pipe.js");
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["J" /* NgModule */])({
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_5_ngx_auto_scroll__["a" /* NgxAutoScrollModule */],
            ...
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_14_time_ago_pipe__["a" /* TimeAgoPipe */]
            ],
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_8__helpers_index__["b" /* fakeBackendProvider */]
            ],
...
module.exports = "<footer class=\"footer\">\n  <div class=\"container-fluid\">\n    <span class=\"text-muted\">© HSG FS 2018 - Team Bananas</span>\n  </div>\n</footer>"
...
module.exports = "<nav class=\"navbar navbar-default\">\n  <div class=\"container-fluid\">\n    <div class=\"navbar-header\">\n      <a class=\"navbar-brand\" href=\"#\">\n        <img alt=\"Brand\" src=\"assets/logos/logo_de.jpg\"  style=\"max-width: 250px;\">\n      </a>\n    </div>\n  </div>\n</nav>"
...
module.exports = "<div class=\"col-lg-12\">\n\n    <h3>Hi {{currentUser.firstName}} {{currentUser.lastName}}!</h3>\n    <p><a [routerLink]=\"['/login']\">Logout <i class=\"fa fa-fw fa-sign-out\"></i></a></p>\n\n  <!-- Content Output -->\n  <!-- Ngx Autoscroll Implementation -->\n <div ngx-auto-scroll lock-y-offset=\"10\" \n  observe-attributes class=\"card\">\n    <div class=\"card-body\">\n      <div class=\"card-text alert alert-secondary\" \n          *ngFor=\"let hero of heroes\">\n          <!-- Username Integration -->\n           <span class=\"username\">{{currentUser.username}}</span>\n            <span class=\"timestamp\">{{hero.date}}</span>\n            <br>{{hero.message}}\n            \n          </div>\n      </div>\n  </div>\n    \n  <!-- Message Input -->\n <div class=\"input-group\">\n    <input #newHero\n      (keyup.enter)=\"addHero(newHero.value); newHero.value='';\"\n      type=\"text\" class=\"form-control\" \n      placeholder=\"Your message ...\">\n    <span class=\"input-group-btn\">\n      <button (click)=\"addHero(newHero.value); newHero.value='';\" \n        class=\"btn btn-primary\" type=\"button\">Send <i class=\"fa fa-fw fa-paper-plane\"></i></button>\n    </span>\n  </div>\n  <!-- /input-group -->\n    \n</div>"
...
var HomeComponent = (function () {
    ...
    HomeComponent.prototype.addHero = function (newHero, date) {
        if (newHero) {
...
module.exports = "<div class=\"col-md-6 col-md-offset-3\">\n    <h2>Register</h2>\n    <form name=\"form\" (ngSubmit)=\"f.form.valid && register()\" #f=\"ngForm\" novalidate>\n        <div class=\"form-group\" [ngClass]=\"{ 'has-error': f.submitted && !username.valid }\">\n            <label for=\"firstName\">First Name</label>\n            <input type=\"text\" class=\"form-control\" name=\"firstName\" [(ngModel)]=\"model.firstName\" #firstName=\"ngModel\" required />\n            <div *ngIf=\"f.submitted && !firstName.valid\" class=\"help-block\">First Name is required</div>\n        </div>\n        <div class=\"form-group\" [ngClass]=\"{ 'has-error': f.submitted && !username.valid }\">\n            <label for=\"lastName\">Last Name</label>\n            <input type=\"text\" class=\"form-control\" name=\"lastName\" [(ngModel)]=\"model.lastName\" #lastName=\"ngModel\" required />\n            <div *ngIf=\"f.submitted && !lastName.valid\" class=\"help-block\">Last Name is required</div>\n        </div>\n        <div class=\"form-group\" [ngClass]=\"{ 'has-error': f.submitted && !username.valid }\">\n            <label for=\"username\">Username</label>\n            <input type=\"text\" class=\"form-control\" name=\"username\" [(ngModel)]=\"model.username\" #username=\"ngModel\" required />\n            <div *ngIf=\"f.submitted && !username.valid\" class=\"help-block\">Username is required</div>\n        </div>\n        <div class=\"form-group\" [ngClass]=\"{ 'has-error': f.submitted && !password.valid }\">\n            <label for=\"password\">Password</label>\n            <input type=\"password\" class=\"form-control\" name=\"password\" [(ngModel)]=\"model.password\" #password=\"ngModel\" required />\n            <div *ngIf=\"f.submitted && !password.valid\" class=\"help-block\">Password is required</div>\n        </div>\n        <div class=\"form-group\">\n            <button [disabled]=\"loading\" class=\"btn btn-primary\">Register <i class=\"fa fa-fw fa-pencil\"></i></button>\n            <img *ngIf=\"loading\" src=\"data:image/gif;base64,\" />\n            <a [routerLink]=\"['/login']\" class=\"btn btn-link\">Cancel <i class=\"fa fa-fw fa-ban\"></i></a>\n        </div>\n    </form>\n</div>\n"
